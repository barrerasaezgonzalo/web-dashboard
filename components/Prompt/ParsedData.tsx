...
export const ParsedDataViewComponent: React.FC<ParsedDataViewProps> = ({
  ...
  <>
    <div className="mt-4 bg-gray-50 p-3 rounded shadow whitespace-pre-line">
      ...
      <p>
        <strong>Instrucciones:</strong> {data.instructions}
      </p>
      <p>
        <strong>Contexto:</strong> {data.context}
      </p>
      <p>
        <strong>Ejemplos:</strong> {data.examples.join(", ")}
      </p>
      <p>
        <strong>Resultado esperado:</strong> {data.expected_output}
      </p>
    </div>
    <button
