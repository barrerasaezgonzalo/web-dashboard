...
`
            ...
            const question = chatCompletion.choices[0]?.message.content?.trim() || "No se pudo generar la pregunta.";
...
Devuelve solo el texto del feedback, sin JSON ni explicaciones adicionales.
      `;
            ...
            const feedback = chatCompletion.choices[0]?.message.content?.trim() || "No se pudo generar feedback.";
